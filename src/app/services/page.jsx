...
const supportFeatures = [
  {
    ...
    item: 'One to one counselling sessions',
    iconClass: 'ph-megaphone',
  },
  {
    id: crypto.randomUUID(),
    item: 'Career awareness workshops & seminars in schools & colleges',
    iconClass: 'ph-projector-screen',
  },
  {
    id: crypto.randomUUID(),
...
export function SupportSection() {
  return (
    <section className='certificate-two pb-120 position-relative z-1 mash-bg-main mash-bg-main-two mash-reverse'>
      <div className='section-heading text-center'>
        <h2 className='mb-24 wow bounceIn'>
          We Support Students Better than Others
        </h2>
        <p className=' wow bounceInUp'>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut
          asperiores provident quos facilis dolore excepturi in.
        </p>
      </div>
              ...
              {supportFeatures.map((feature, index) => (
                <div
                  ...
                  <div className='flex-align gap-20 mb-12'>
                    <span
                      className='flex-center d-inline-flex bg-main-25 rounded-circle text-main-600 text-2xl'
                      style={{ padding: '0.5rem' }}>
                      <i
                        className={`animate__wobble ph-bold ${feature.iconClass}`}
                      />
                    </span>
      ...
      <div className='container'>
        ...
        <div className='section-heading text-center'>
          <div className='flex-align d-inline-flex gap-8 mb-16 wow bounceInDown'>
            ...
            <h5 className='text-main-600 mb-0'>Our Premium ..</h5>
          </div>
          <h2 className='mb-24 wow bounceIn'>
            We understand student before giving college any advice
          </h2>
          <p className='wow bounceInUp'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur,
            asperiores aut alias voluptatem dolore magnam eum.
          </p>
        </div>
            ...
            <div className='col-lg-4 col-sm-6' key={service.id}>
              <div className='course-item bg-main-25 rounded-16 p-12 h-100 border border-neutral-30'>
                ...
                <div className='course-item__content'>
                  <div className=''>
                    <h4 className='mb-28'>
                      <Link href='#' className='link text-line-2'>
                        {service.title}
                      </Link>
                    </h4>
                    ...
                    <div className='flex-between gap-8 flex-wrap'>
                      {service.features.map((feature) => (
                        <div
                          className='flex-align gap-8 align-items-start'
