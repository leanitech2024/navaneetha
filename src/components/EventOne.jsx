...
const upcomingEvents = [
  {
    ...
    date: '25',
    month: 'May, 2026',
    time: '02:30:am to 04:25:pm',
    location: 'Bengaluru',
    title: 'Seminar on Comedk counselling and seat allocation',
    link: '/contact',
  },
  {
    id: crypto.randomUUID(),
    ...
    time: '02:30:am to 04:25:pm',
    location: 'Bengaluru',
    title: 'Seminar on KCET counselling and allocation Details',
    link: '/contact',
  },
  {
    id: crypto.randomUUID(),
    ...
    time: '02:30:am to 04:25:pm',
    location: 'Bengaluru',
    title: 'Seminar on NEET counselling and Seat allocation',
    link: '/contact',
  },
];
              ...
              {upcomingEvents.map((event, index) => (
                <div
                  ...
                  <div className=''>
                    ...
                    <span className='text-neutral-500'>{event.month}</span>
                  </div>
                  <span className='border border-neutral-40 border-dashed h-72' />
                  <div className=''>
                    <div className='flex-between gap-16 flex-wrap mb-16'>
                    ...
                    <h4
                      className='mt-12 mb-0 fs-6 text-break'
