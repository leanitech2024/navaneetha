            ...
            <div className="choose-us__content">
              <div className="mb-40">
                ...
                <h2 className="mb-24  wow bounceIn">
                  Your Trusted Partner for Education &amp; Career Growth
                </h2>
                <p className="text-neutral-500 text-line-2  wow bounceInUp">
                  ...
                  guidance. From selecting the right course to securing
                  admission in top colleges, our expert team is with you every
                  step of the way.
                </p>
              </div>
              <ul>
                ...
                >
                  ...
                  <span className="flex-grow-1 text-neutral-500">
                    Expert Career Counselling & Guidance
                  </span>
                </li>
                <li
                  className="flex-align gap-12 mb-16"
                ...
                >
                  ...
                  <span className="flex-grow-1 text-neutral-500">
                    100% Admission Assistance in Top Colleges
                  </span>
                </li>
                <li
                  className="flex-align gap-12 mb-16"
                ...
                >
                  ...
                  <span className="flex-grow-1 text-neutral-500">
                    End-to-End Support for NEET/CET Students
                  </span>
                </li>
              </ul>
